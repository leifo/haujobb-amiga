 ...
 *  17  |   Y   |   Y   | 220x180x15 from 24-bit
 *  18  |   Y   |   Y   | 220x180x15 from 18-bit
 *  19  |   Y   |   Y   | 220x90x15 from 18-bit
 *  20  |   Y   |   Y   | 220x180x18 from 24-bit
 *  21  |   Y   |   Y   | 220x180x18 from 18-bit
 *  22  |   Y   |   Y   | 220x90x18 from 18-bit
 *  23  |   Y   |   Y   | 220x180x12 from 18-bit
 *  24  |   N   |   Y   | 320x180x5 OCS, wrong colours (due to GIF?)
 *  25  |   N   |   Y?  | 320x180x5 OCS w. copper colours, wrong colours (due to GIF?, black spots on Amiga due to non-init)
 * 
 * */

// working perfectly on Amiga and PC: 8-14, 16-23
