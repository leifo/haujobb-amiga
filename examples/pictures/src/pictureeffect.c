...
void pictureEffectInit()
{
   ...
   gifLoad("data/10.gif", (void**)&picture1, &w,&h, (unsigned int*)&picture1pal);
   gifLoad("data/09.gif", (void**)&picture2, &w,&h, (unsigned int*)&picture2pal);
   gifLoad("data/08.gif", (void**)&picture3, &w,&h, (unsigned int*)&picture3pal);
   gifLoad("data/07.gif", (void**)&picture4, &w,&h, (unsigned int*)&picture4pal);
   gifLoad("data/06.gif", (void**)&picture5, &w,&h, (unsigned int*)&picture5pal);
   gifLoad("data/05.gif", (void**)&picture6, &w,&h, (unsigned int*)&picture6pal);
   gifLoad("data/04.gif", (void**)&picture7, &w,&h, (unsigned int*)&picture7pal);
   gifLoad("data/03.gif", (void**)&picture8, &w,&h, (unsigned int*)&picture8pal);
   gifLoad("data/02.gif", (void**)&picture9, &w,&h, (unsigned int*)&picture9pal);
   gifLoad("data/01.gif", (void**)&picture10, &w,&h, (unsigned int*)&picture10pal);
