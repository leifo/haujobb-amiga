...
; 30.12.16 - shift around from rgb888 to rgb666
;          - saturation on the fly
;          - i.e. format is now oo111112 per rgb component
;          -- oo is overflow area which get automatically saturated
;          -- (c.f. ada.untergrund.net/?p=boardthread&id=469)
;          -- 1 is your 5 bits payload
;          -- 2 is for extra precision and will be disregarded during c2p
; 09.01.17 - reduced to 4 bitplane writes, i.e. ham6
;          - profile01: removed write3 and calculations of a4 - about 16000 ms per 220x180 frame on a1260/64
;          - profile02: used a4 as temp (instead of a3), not speed difference, but cleaner code
;          - profile03: removed some shifts
...
c2p_4rgb888_3rgb555h8_040
	...
	lsr.l	#1,d0	;shift down from 6 bit precision
	lsr.l	#1,d1
	lsr.l	#1,d2
	lsr.l	#1,d3
	lsr.l	#1,d4
	...
	lsr.l	#1,d6	;shift down from 6 bit precision
	addq.l	#4,a0
	move.l	d6,a5	;d6 free
		MODIFY_WORD	d7,d6
		lsr.l	#1,d7	;shift down from 6 bit precision
	move.l	d7,a6
