...
*        changes that are marked with ";!!!" to your source!
*
* Note2: INTREQ ($dff09c) must ALWAYS be written twice on A4040,A4060.
...
;makebin	;uncomment this and a new binary will be
		;AUTO-saved to "ram:610.4.bin_new" (ASM-One only)
...
;	include Player61.i
        ifd	asmone
        include	wos:sub/replay/infos.s
        endc
...
P61_periods
	ifne	P61_ft
	incbin	wos:sub/replay/periods
	else
	incbin	wos:sub/replay/periods.nft
	endc
...
;samples
	...
	ifd    asmone
	ifd     makebin
	auto    wb ram:610.4.bin_new\P61_motuuli\P61_etu\
	endc
	endc
;	END
